...
def run(pptx: Path, out_dir: Path, language: str = "auto", progress: Progress = lambda s, m: None) -> dict:
    ...
    result, checks = grade(deck, metrics, lang)

    progress("reporting", "")
    payload = {"language": lang, "deck": deck.to_dict(), "metrics": metrics,
